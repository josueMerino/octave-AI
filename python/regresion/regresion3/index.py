...
co2_url="co2-annmean-mlo_json.json"

# Nivel medio del mar: https://datahub.io/core/sea-level-rise#data
# Nivel medio del mar anual (formato json)
# https://pkgstore.datahub.io/core/sea-level-rise/epa-sealevel_json/data/ac016d75688136c47a04ac70298e42ec/epa-sea-level_json.json
sea_url="epa-sea-level_json.json"

# Masa glaciar media: https://datahub.io/core/glacier-mass-balance
# Masa glaciar media anual (formato json)
# https://pkgstore.datahub.io/core/glacier-massbalance/glaciers_json/data/6270342ca6134dadf8f94221be683bc6/glaciers_json.json
glaciar_url="glaciers_json.json"

# lectura de la información de los ficheros JSON
with open(temp_url) as f:
    temp_data = json.load(f)

with open(co2_url) as url:
    co2_data = json.load(url)

with open(sea_url) as url:
    sea_data = json.load(url)

with open(glaciar_url) as url:
    glaciar_data = json.load(url)
...
# Predecir la concentración de CO2 para una anomalía de 0.8, nivel medio del mar de 0.3 y masa media de los glaciares del mundo de -6.8
